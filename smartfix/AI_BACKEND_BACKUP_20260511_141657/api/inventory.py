...
DEVICE_CATALOG = [
    {
        ...
        'brand': 'Apple',
        'category': 'Phone',
        'price_range': '1,200,000 - 1,500,000',
        'market_demand': 'high',
        'profit_margin': 'high',
        'base_score': 4.0
    },
    ...
    },
    {
        ...
        'brand': 'Apple',
        'category': 'Laptop',
        'price_range': '1,800,000 - 2,200,000',
        'market_demand': 'high',
        'profit_margin': 'medium',
        'base_score': 4.2
    },
    {
        ...
        'brand': 'Apple',
        'category': 'Laptop',
        'price_range': '2,500,000 - 3,500,000',
    ...
    },
    {
        ...
        'brand': 'Dell',
        'category': 'Laptop',
        'price_range': '1,200,000 - 1,600,000',
        'market_demand': 'medium',
        'profit_margin': 'medium',
        'base_score': 3.3
    },
    ...
    },
    {
        ...
        'brand': 'Lenovo',
        'category': 'Laptop',
        'price_range': '1,400,000 - 1,800,000',
        'market_demand': 'medium',
        'profit_margin': 'medium',
        'base_score': 3.2
    },
    {
        ...
        'brand': 'Apple',
        'category': 'Tablet',
        'price_range': '1,500,000 - 2,000,000',
        'market_demand': 'medium',
        'profit_margin': 'high',
        'base_score': 3.4
    },
        ...
        if product_id in inventory_map:
            ...
            if current_stock == 0 and sales_count >= 5:
                gaps.append({
                    ...
                    'category': inventory_item.get('category', {}).get('name', 'Unknown'),
