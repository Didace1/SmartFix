...
def analyze_chat_intent(message):
...
def generate_chat_response(intent, message):
    """Generate appropriate response based on intent"""
    
    if intent == 'greeting':
        return {
            "message": CHATBOT_KNOWLEDGE["greetings"][0],
            "suggestions": [
        ...
        if smartphones:
            ...
            response = CHATBOT_KNOWLEDGE["device_categories"]["smartphones"]
        ...
        if laptops:
            ...
            response = CHATBOT_KNOWLEDGE["device_categories"]["laptops"]
        ...
        return {
            "message": CHATBOT_KNOWLEDGE["device_categories"]["tablets"],
            "suggestions": [
                "Tell me about iPads",
        ...
        return {
            "message": CHATBOT_KNOWLEDGE["device_categories"]["smartwatches"],
            "suggestions": [
        ...
        return {
            "message": CHATBOT_KNOWLEDGE["device_categories"]["accessories"],
            "suggestions": [
        ...
        return {
            "message": CHATBOT_KNOWLEDGE["repair_issues"]["screen"] + " We offer free diagnosis and competitive pricing with warranty on all screen repairs.",
            "suggestions": [
        ...
        return {
            "message": CHATBOT_KNOWLEDGE["repair_issues"]["battery"] + " We use genuine batteries and provide warranty on all battery replacements.",
            "suggestions": [
        ...
        return {
            "message": CHATBOT_KNOWLEDGE["repair_issues"]["water_damage"] + " Time is critical for water damage - bring your device as soon as possible for best results.",
            "suggestions": [
        ...
        return {
            "message": CHATBOT_KNOWLEDGE["services"]["repair"],
            "suggestions": [
        ...
        return {
            "message": f"{CHATBOT_KNOWLEDGE['services']['repair']}\n\n{CHATBOT_KNOWLEDGE['services']['devices']}",
            "suggestions": [
        ...
        return {
            "message": CHATBOT_KNOWLEDGE["services"]["pricing"] + " Contact us for specific pricing on repairs or device purchases.",
            "suggestions": [
                "Get repair quote",
                "See device prices",
                "Contact information",
        ...
        return {
            "message": f"{CHATBOT_KNOWLEDGE['contact']['location']}\n{CHATBOT_KNOWLEDGE['contact']['hours']}\n{CHATBOT_KNOWLEDGE['contact']['phone']}",
            "suggestions": [
                "Get directions",
                "Call now",
        ...
        return {
            "message": CHATBOT_KNOWLEDGE["services"]["warranty"],
            "suggestions": [
...
async def chat_with_bot(request: ChatRequest):
    ...
    try:
        ...
        response_data = generate_chat_response(intent, message)
